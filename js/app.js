                      ...
                      do {
                        if (!0 === e && d.validPositions[b])
                          ...
                          ("number" == typeof y && isFinite(y) && y > b)
                            ? g.push(!1 === i ? h.nativeDef : o.call(r, b, h))
                            : (v = !1);
                        }
                        b++;
                            ...
                            if (-1 === O || "string" == typeof O) {
                              ...
                              for (var N = 0; N < D.length; N++) {
                                (A = parseInt(D[N])),
                                  (v = []),
                                  (i =
                                    ("string" == typeof O && m(h, A, _)) ||
                                    I.slice());
                                var G = C.matches[A];
                                if (G && o(G, [A].concat(s), c)) r = !0;
                                else if (
                                  (0 === N && (M = !0),
                                  G &&
                                    G.matches &&
                          ...
                          if (
                            ...
                            !1 !==
                              (o =
                                ...
                                (null != p.fn
                                  ? p.fn.test(i, k, t, r, y, u.call(g, e))
                                  : (i === p.def ||
                        ...
                        if (
                          ...
                          if (
                            ...
                            if (
                              ...
                              !_ &&
                                !s.isMask.call(g, w, y.keepStatic && 0 === w))
                            )
                              for (
                                var M = w + 1,
                  ...
                  function v(e, t, i, n) {
                    ...
                    if (
                      ...
                      var g,
                        ...
                        y = s.getLastValidPosition.call(r, void 0, !0);
                      for (o.p = h, g = y; g >= h; g--)
                      ...
                      for (
                        ...
                        if (
                          ...
                          for (; "" !== a.getTest.call(r, E).match.def; ) {
                            ...
                            if ((!v && s.getBuffer.call(r), E > o.maskLength))
                              break;
                            E++;
                          }
                          "" == a.getTest.call(r, E).match.def && (v = !1),
                            (E = x);
                        }
                        if (!v) break;
                      }
      ...
      732: function (e) {
        e.exports = (function () {
          ...
          var t = "undefined" != typeof window,
            ...
            U = function (e, t) {
              K(e, u, w(e, t.data_sizes)),
                K(e, d, w(e, t.data_srcset)),
                K(e, c, w(e, t.data_src));
            },
            Y = {
              IMG: function (e, t) {
                $(e, function (e) {
  ...
  (() => {
    ...
    const C = {
      ...
      on: function (...e) {
        ...
        function r(e) {
          ...
          if ((a.indexOf(e) < 0 && a.unshift(e), x(t).is(i))) n.apply(t, a);
          else {
            const e = x(t).parents();
            for (let t = 0; t < e.length; t += 1)
              x(e[t]).is(i) && n.apply(e[t], a);
          }
        }
        function s(e) {
      ...
      is: function (e) {
        ...
        if ("string" == typeof e) {
          ...
          for (a = x(e), r = 0; r < a.length; r += 1) if (a[r] === n) return !0;
          return !1;
        }
        if (e === i) return n === i;
        if (e === t) return n === t;
            ...
            void 0 !== a &&
              ...
              (O(t[n]) && O(r[n])
                ? r[n].__swiper__
                  ...
                  : A(t[n], r[n])
                : !O(t[n]) && O(r[n])
                ? ((t[n] = {}), r[n].__swiper__ ? (t[n] = r[n]) : A(t[n], r[n]))
                : (t[n] = r[n]));
          }
        }
      }
    ...
    const F = {
      ...
      updateSlides: function () {
        ...
        for (let a = 0; a < u; a += 1) {
          ...
          const s = d.eq(a);
          if (
            (E && e.grid.updateSlide(a, s, u, t), "none" !== s.css("display"))
          ) {
      ...
      slideTo: function (e = 0, t = this.params.speed, i = !0, n, a) {
        ...
        if (o.cssMode) {
          ...
          if (0 === t) {
            ...
            if (!r.support.smoothScroll)
              return (
                I({ swiper: r, targetPosition: i, side: e ? "left" : "top" }),
                !0
              );
    ...
    const q = {
      loopCreate: function () {
        ...
        for (let e = s.length - 1; e >= 0; e -= 1)
          a.prepend(T(s[e].cloneNode(!0)).addClass(i.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    class ce {
      constructor(...e) {
        ...
        (n.__swiper__ = !0),
          (n.support = j()),
          (n.device = R({ userAgent: i.userAgent })),
          (n.browser = N()),
          (n.eventsListeners = {}),
      ...
      t({
        ...
        i("click", (t, i) => {
          const { $nextEl: a, $prevEl: r } = e.navigation,
            s = i.target;
          if (e.params.navigation.hideOnClick && !T(s).is(r) && !T(s).is(a)) {
            if (
              e.pagination &&
              e.params.pagination &&
    ...
    function he({ swiper: e, extendParams: t, on: i, emit: n }) {
      ...
      function d() {
        ...
        if ("bullets" === t.type) {
          ...
          a.html(r), (e.pagination.bullets = a.find(fe(t.bulletClass)));
        }
        "fraction" === t.type &&
          ((r = t.renderFraction
    ...
    window.addEventListener("load", function (e) {
      !(function () {
        if (
          (ge(),
          document.querySelector(".slider-blog__slider") &&
            new de(".slider-blog__slider", {
              modules: [pe, he],
              observer: !0,
              observeParents: !0,
              slidesPerView: 3,
              ...
              speed: 800,
              loop: !0,
              pagination: { el: ".slider-blog__dotts", clickable: !0 },
              breakpoints: {
                320: { slidesPerView: 1 },
                800: { slidesPerView: 2 },
                992: { slidesPerView: 2 },
          ...
          document.querySelector(".main-block-product-cart"))
        ) {
          const e = new de(".thums-main-block-product-cart-sub", {
            modules: [pe, ve],
            observer: !0,
            observeParents: !0,
            slidesPerView: 6,
            ...
            breakpoints: {
              ...
              767: { slidesPerView: 4 },
              992: { slidesPerView: 6 },
              1268: { slidesPerView: 6, spaceBetween: 10 },
            },
          });
          new de(".main-block-product-cart__slider", {
            modules: [pe, ve, me],
        ...
        document.querySelector(".products-slider__slider") &&
          new de(".products-slider__slider", {
            modules: [pe, he, me],
        ...
        [].forEach.call(document.querySelectorAll(".tel"), function (e) {
          ...
          function i(e) {
            ...
            var i = "+7 (___) ___-__-__",
              ...
              s = i.replace(/[_\d]/g, function (e) {
                return n < r.length ? r.charAt(n++) || a.charAt(n) : e;
              });
            -1 != (n = s.indexOf("_")) &&
              (n < 5 && (n = 3), (s = s.slice(0, n)));
            var o = i
